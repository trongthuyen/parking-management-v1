...
class Tracking:
  ...
  def track_parking_lots(self, frame, video_cur_pos=9999999999, export_path=None):
    # No image found
    if not frame.any():
      ...
      for ind, park in enumerate(self.parking_data):
        ...
        # If status is still different than the one saved and counter is open
          ...
          if video_cur_pos - self.parking_buffer[ind] > self.config['park_sec_to_wait']:
            ...
            elif not export_path and not os.path.isdir(self.export_path):
